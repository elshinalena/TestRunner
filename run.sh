...
if [ -d "$HOME/Documents/$WS_DIR" ] ; then cd ~/Documents/$WS_DIR; else echo $WS_DIR directory is not exist; return; fi

if [ -d "$HOME/Documents/$WS_DIR/$REPO_NAME" ]; then rm -rf $HOME/Documents/$WS_DIR/$REPO_NAME; fi
...
#echo $MAIN_CLASS
#echo $ARGS_01
#echo "$HOME/Documents/$WS_DIR/$REPO_NAME/target/$REPO_NAME-$APP_VERSION.jar"
